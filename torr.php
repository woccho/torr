...
$CONFIG = array(
    ...
    "comix" => array(     # 만화
        "https://torrenthaja.com/bbs/board.php?bo_table=torrent_toon&sca=&sop=and&sfl=wr_subject&stx={k}"
    ),
    "kmov" => array(     # 한국영화
        "https://torrenthaja.com/bbs/board.php?bo_table=torrent_kmovie&sca=&sop=and&sfl=wr_subject&stx={k}"
    ),
    "mov" => array(     # 해외영화
        "https://torrenthaja.com/bbs/board.php?bo_table=torrent_movie&sca=&sop=and&sfl=wr_subject&stx={k}"
    ),
    "ani" => array(     # 애니
        "https://torrenthaja.com/bbs/board.php?bo_table=torrent_ani&sca=&sop=and&sfl=wr_subject&stx={k}"
    ),
    ...
    "all" => array("kmovie", "movie", "ent", "drama", "docu", "mid","ani", "comix"),
